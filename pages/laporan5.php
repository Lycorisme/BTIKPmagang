...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            <a href="../process/export_pdf.php?type=laporan5" class="btn btn-danger" title="Download langsung sebagai PDF">
                <i class="bi bi-file-pdf"></i> Download PDF
            </a>
            <a href="../process/print_report.php?type=laporan5" class="btn btn-primary" target="_blank" title="Buka halaman cetak (alternatif jika download gagal)">
